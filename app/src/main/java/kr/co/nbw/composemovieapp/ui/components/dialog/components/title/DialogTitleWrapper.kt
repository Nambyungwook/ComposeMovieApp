package kr.co.nbw.composemovieapp.ui.components.dialog.components.title
...
import kr.co.nbw.composemovieapp.ui.theme.h5Title
...
fun HeaderDialogTitle(title: DialogTitle.Header) {
    Column(
        modifier = Modifier
            .fillMaxWidth()
            .background(MaterialTheme.myColorScheme.primary)
